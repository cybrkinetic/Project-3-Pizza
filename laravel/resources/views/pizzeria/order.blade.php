        ...
        <div class="flex-1 space-y-4">
            ...
            <div class="flex justify-between items-center bg-[#666060] text-white rounded-md p-4 shadow-md">
                ...
                <div class="flex items-center">
                    ...
                    <form class="pizzalist" action="{{ route('order.destroy', $besteldePizza->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="text-[#72C35C] underline hover:text-[#61A84E]">Verwijderen</button>
                    </form>
                </div>
            </div>
            @endforeach
